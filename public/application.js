...
var addHandlers = function addHandlers() {
  ...
  $('.box').on('click', function (event) {
    ...
    // If tie game
    if ($('#cell0').text() !== '' && $('#cell1').text() !== '' && $('#cell2').text() !== '' && $('#cell3').text() !== '' && $('#cell4').text() !== '' && $('#cell5').text() !== '' && $('#cell6').text() !== '' && $('#cell7').text() !== '' && $('#cell8').text() !== '') {
      $('#game-message').text('Game Over. It\'s a draw. No one wins this game.').fadeIn(5000).fadeOut(5000), $('.game-board').hide();
    }
