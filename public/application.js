...
var player1WinsSuccess = function player1WinsSuccess(data) {
  $('#game-message').text('Player X Wins!');
  console.log(this);
};

var player2WinsSuccess = function player2WinsSuccess(data) {
  $('#game-message').text('Player O Wins!');
  console.log(this);
};

module.exports = {
  player1WinsSuccess: player1WinsSuccess,
  player2WinsSuccess: player2WinsSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
